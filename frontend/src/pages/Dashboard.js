            ...
            <div className="space-y-12">
                <div className="flex flex-col md:flex-row md:items-end justify-between pb-8 border-b border-border/60 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="px-5 py-2 bg-primary/5 rounded-2xl text-sm font-bold border border-primary/10 tracking-wide shadow-inner">
                            Percentile: <span className="text-primary">{percentile}%</span>
                        </div>

                        <button
                            onClick={handleSaveReport}
                            className="px-5 py-2 bg-black text-white rounded-2xl font-bold hover:opacity-90 transition"
                        >
                            Save Report
                        </button>
                    </div>
